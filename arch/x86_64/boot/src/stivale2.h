...
namespace Stivale_v2::Stivale {
        ...
        namespace Struct {
                ...
                struct EFISystemTable : Tag {
                        uintptr_t systemTable;
                };

                struct KernelFile : Tag {
                        uintptr_t kernelFile;
                };
                struct KernelFile_v2 : Tag {
                        uintptr_t kernelFile;
                        size_t kernelSize;
                };
                ...
                struct BootVolume : Tag {
                        uint64_t flags;
                        GUID guid;
                        GUID part_guid;
                };

                struct KernelSlide : Tag {
                ...
                struct PXEServerInfo : Tag {
                        uint32_t serverIp;
                };

                struct MMIO32UART : Tag {
                        uintptr_t address;
                };

                struct DeviceTreeBlob : Tag {
                        uintptr_t address;
                        size_t size;
                };
